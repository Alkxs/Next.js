  ...
  return (
    <div>
      ...
      <Alert variant='secondary'>
        <p>
          Note: In order to load the data on this site, you need to get a <a href='https://unsplash.com/developers'>free API key from Unsplash</a> and add it to
          your <code>.env.local</code> file as <code>UNSPLASH_ACCESS_KEY</code>.
        </p>
